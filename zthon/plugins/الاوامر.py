...
async def zed_handler(event):
    ...
    if query.startswith("ريفز") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("سورس زد إي العربي - UI_9U USERBOT", "https://t.me/UI_9U"),],[Button.url("الفـارات", "https://t.me/UI_XC"),],[Button.url("الشـروحـات¹", "https://t.me/UI_9U"),],[Button.url("كــلايــش زد إي", "https://t.me/UI_XC"),],[Button.url("مطـور السـورس", "https://t.me/UP_UO"),]]
...
async def zed_handler(event):
    ...
    if query.startswith("السورس") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("سورس زد إي العربي - 𝗭𝗘 USERBOT", "https://t.me/UI_9U")]]
