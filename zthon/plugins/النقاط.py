...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲 𝐙𝐄 - اوامـر تجميـع النقـاط](t.me/UI_9U) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**@UP_UO ضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @UP_UO**"
)
