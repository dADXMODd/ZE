...
zel_dev = (6686509758, 6686509758, 6686509758, 6686509758)
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://telegra.ph/file/921d1b5b01027998a3079.jpg"
    if event.is_private:
        ...
        if event.chat_id == 6686509758 or event.chat_id == 6686509758 or event.chat_id == 6686509758:
